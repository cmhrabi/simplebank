...
func TestTransferTx(t *testing.T) {
	...
	arg := TransferTxParams{
		...
		Amount:        int64(utils.RandomInt(0, int(account1.Balance))),
	}
	...
	require.Equal(t, account1.Balance, result.FromAccount.Balance+arg.Amount)
	require.Equal(t, account2.Balance, result.ToAccount.Balance-arg.Amount)
}

func TestTransferTxCon(t *testing.T) {
	account1 := CreateNewAccount(t)
	account2 := CreateNewAccount(t)
